         ...
         <div className="mt-16 space-y-8">
            <div>
              ...
              <nav className="flex flex-col gap-4 items-start">
                {[
                  { id: 'top', label: 'Inicio' },
                  { id: 'seccion-tecnologia', label: 'Tecnología' },
                  { id: 'seccion-negocios', label: 'Negocios' },
                  { id: 'seccion-mercados', label: 'Mercados' }
                ].map((item) => (
                    <button key={item.id} onClick={() => irASeccion(item.id)} className="group relative text-left text-2xl font-display font-bold text-white w-fit">
      ...
      <header className="fixed top-0 w-full z-[80] px-6 py-6 pointer-events-none">
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
            <a href="/" className="pointer-events-auto block">
                <div className="bg-black/40 backdrop-blur-md rounded-full p-2 pr-5 flex items-center gap-3 border border-white/30 shadow-lg cursor-pointer hover:bg-black/60 transition-all" onClick={() => irASeccion('top')}>
        ...
        <main className="pt-36 pb-20 max-w-[1440px] mx-auto px-6">
            ...
            <section id="seccion-tecnologia" className="mb-24">
              ...
              {cargandoDatos ? (
                ...
                <div className="mb-6 relative rounded-2xl overflow-hidden group bento-card border-none h-[500px]">
                    ...
                    <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full z-20 max-w-4xl">
                        ...
                        <a href={techHero.source_url} target="_blank" rel="noreferrer" className="bg-white text-black font-bold px-6 py-3 rounded-lg inline-flex items-center gap-2 hover:bg-primary hover:text-white transition-all shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_20px_rgba(25,140,179,0.5)]">
                          Leer noticia <span className="material-symbols-outlined text-sm">arrow_outward</span>
                        </a>
                    </div>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {cargandoDatos 
                  ...
                  <div key={idx} className="bento-card rounded-2xl p-6 flex flex-col justify-between h-[280px] group cursor-pointer" onClick={() => window.open(noticia.source_url, '_blank')}>
                      <div>
              ...
              {cargandoDatos ? (
                ...
                <div className="mb-6 relative rounded-2xl overflow-hidden group bento-card border-none h-[500px]">
                    ...
                    <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full z-20 max-w-4xl">
                        ...
                        <a href={businessHero.source_url} target="_blank" rel="noreferrer" className="bg-white text-black font-bold px-6 py-3 rounded-lg inline-flex items-center gap-2 hover:bg-emerald-500 hover:text-white transition-all shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_20px_rgba(16,185,129,0.5)]">
                          Leer reporte <span className="material-symbols-outlined text-sm">arrow_outward</span>
                        </a>
                    </div>
                </div>
              )}
